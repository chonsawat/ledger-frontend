        ...
        <div className="my-5">
            <form action="#" method="POST" className="border rounded-xl ml-2 mr-4">
                <div className="flex my-2 mx-2 mt-5">
                    ...
                    <input type="text" placeholder="Date" className="border rounded-sm" />
                    <br />
                </div>
                <div className="flex my-2 mx-2">
                    <p className="mr-2">Description: </p>
                    <input type="text" placeholder="Description" className="border rounded-sm" />
                    <br />
                </div>
                <div className="flex my-2 mx-2">
                    <p className="mr-2">Credit Account: </p>
                    <input type="text" placeholder="Credit Account" className="border rounded-sm" />
                    <br />
                </div>
                <div className="flex my-2 mx-2">
                    <p className="mr-2">Credit Amount: </p>
                    <input type="text" placeholder="Credit Amount" className="border rounded-sm" />
                    <br />
                </div>
                <div className="flex my-2 mx-2">
                    <p className="mr-2">Debit Account: </p>
                    <input type="text" placeholder="Debit Account" className="border rounded-sm" />
                    <br />
                </div>
                <div className="flex my-2 mx-2">
                    <p className="mr-2">Debit Amount: </p>
                    <input type="text" placeholder="Debit Amount" className="border rounded-sm" />
                    <br />
                </div>
                <div className="flex my-2 mx-2">
                    <p className="mr-2">Total Credit Balance: </p>
                    <input type="text" placeholder="Total Credit Balance" className="border rounded-sm" />
                    <br />
                </div>
                <div className="flex my-2 mx-2">
                    <p className="mr-2">Total Debit Balance: </p>
                    <input type="text" placeholder="Total Debit Balance" className="border rounded-sm" />
                    <br />
                </div>
