                            ...
                            return (
                                <div key={key} className="w-full">
                                    <table className="text-center min-w-max shadow-md w-full">
                                        ...
                                        <TableBody date={key} data={filteredLedger}></TableBody>
                                    </table>
...
function SearchBar() {
    ...
    return (
        <div className="flex">
            <AddButton></AddButton>
            <input type="text" placeholder="Search Desc" className="w-420 mt-2.5 mb-5 py-2 px-3 border rounded-xl border-gray-500 sm:w-[75%] md:w-[90%] lg:w-full" onChange={(e) => onChangeHandler(e)} />
        </div>
    )
}
